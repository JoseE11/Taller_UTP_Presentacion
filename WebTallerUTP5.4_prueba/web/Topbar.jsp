<%-- 
    Document   : Topbar
    Created on : 08/06/2022, 05:00:03 PM
    Author     : Usuario
--%>
    ...
    <link href="css/clockpicker.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Seleccione "Salir" abajo si desea salir y cerrar su sesion actual.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="login_1.jsp">Salir</a>
                </div>
            </div>
        </div>
    </div>
