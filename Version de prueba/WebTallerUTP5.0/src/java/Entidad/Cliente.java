...
public class Cliente extends Persona {
  ...
  int id_distrito;
    public Cliente(String distrito, String direccion, int DNI, int telefono, String tipo, int estado_persona, String nombre, String ap_paterno, String ap_materno, String correo_electronico) {
