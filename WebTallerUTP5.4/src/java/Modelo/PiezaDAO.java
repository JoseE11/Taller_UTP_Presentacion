...
Pieza pi=new Pieza();
   ...
   ArrayList<Pieza>list=new ArrayList<>();
       String sql="select * from piezas where estado_pieza = '+1+' ";
        try {
    ...
    public boolean add(Pieza pie) {
     String sql="insert into piezas (id_pieza, nombre_pieza, descripcion_pieza, estado_pieza)values('"+pie.getId_pieza()+"','"+pie.getNombre_pieza()+"','"+pie.getDescripcion()+"','1')";
    ...
    public boolean eliminar(int id) {
        ...
        String sql="update piezas set estado_pieza='0' where id_pieza="+id;
        try {
            con=cn.getConnection();
            ps=con.prepareStatement(sql);
            ps.executeUpdate();
