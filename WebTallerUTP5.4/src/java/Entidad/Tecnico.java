...
public class Tecnico extends Persona{
 ...
 int horario;
    ...
    public Tecnico(String especialidad, String experiencia_labo, int horario, int DNI, int telefono, int tipo, int estado_persona, String nombre, String ap_paterno, String ap_materno, String correo_electronico) {
