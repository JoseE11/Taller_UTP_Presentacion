  ...
  <body>
      <div class="container-fluid">
          <div class="row container-fluid " style="padding: 0" >
            ...
            <div class="card ">
                <div class="card-body">
                    <h2 class="title">Registro de Piezas</h2>
                    <form method="POST">
                        <div class="row">
                            <div>
                            ...
                            <div class="row">
                            <div class="mb-3 col">
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Nombre de Pieza">
                            </div>
                            </div>
                            ...
                            <div class="row py-3">
                                <h4>Descripción</h4>
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Descripción de Pieza</label>
              ...
              <div class="card">
                  <div class="card-body">
                      ...
                      <tbody>
                          <tr>
                              <th scope="row">1</th>
                              <td>Pantalla Huawei</td>
                              <td>Modelo P-30</td>
                              <td><button type="button" class="btn btn-dark">Escoger</button>
